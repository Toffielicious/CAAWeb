...
const Slider = () => {
  ...
  const images = [
    ...
    { src: 'https://scontent.fmnl30-1.fna.fbcdn.net/v/t39.30808-6/329333478_740065220718338_4634636903674661411_n.jpg?stp=cp6_dst-jpg&_nc_cat=107&ccb=1-7&_nc_sid=8bfeb9&_nc_ohc=udZQ-PWEhZoAX_M-WLc&_nc_ht=scontent.fmnl30-1.fna&oh=00_AfBhfNXtVwQ7qhgRnymOA5b9A-pFTkPMUi83TvAYmWxp0w&oe=64664424'},
    { src: 'https://scontent.fmnl30-3.fna.fbcdn.net/v/t39.30808-6/317722517_2792529520891946_4129367611444756148_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=8bfeb9&_nc_ohc=8jf3tc8_rOsAX8PkI2M&_nc_ht=scontent.fmnl30-3.fna&oh=00_AfA4qz03z9sC4GqxL5GQOLySM3f8AZ0SMkVAXk8nomnFMQ&oe=64655DAC'},
    ...
    <div className='' style={{ height: '400px' }} >
      <Carousel className=''  interval={3500} showThumbs={false} showStatus={false} infiniteLoop={true} autoPlay >
        ...
        {images.map((img, index) => (
          <img key={index} src={img.src} className='object-cover sliderSection' />
        ))}
